...
export const ExportModal: React.FC<ExportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-3 sm:p-4 overflow-y-auto">
      <div className="bg-[#0e1219] border border-[#212734] rounded-lg max-w-lg w-full p-5 sm:p-6 shadow-2xl space-y-4 my-auto max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between border-b border-[#212734] pb-3">
          ...
          <button
            onClick={onClose}
            className="p-1.5 text-slate-400 hover:text-slate-100 rounded hover:bg-[#1a202c] transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className={`p-2.5 rounded-md border text-xs font-bold transition text-center ${
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className={`p-2 rounded-md border text-xs font-bold transition text-center ${
                exportFormat === 'srt'
                  ? 'bg-emerald-500/15 border-emerald-500/60 text-emerald-300 shadow-sm'
                  : 'bg-[#07090e] border-[#212734] text-slate-400 hover:bg-[#12161f]'
              }`}
        ...
        <div className="bg-[#07090e] border border-[#212734] p-3 rounded-md">
        ...
        {/* File Info Notice */}
        <div className="bg-[#07090e] border border-[#212734] p-3 rounded-md text-xs text-slate-400 flex items-center justify-between">
        ...
        {/* Actions */}
        <div className="flex items-center justify-end space-x-2.5 pt-2 border-t border-[#212734]">
          <button
            onClick={handleCopy}
            className="px-3.5 py-2 rounded-md bg-[#12161f] hover:bg-[#1a202c] border border-[#212734] text-slate-200 text-xs font-semibold transition flex items-center space-x-1.5"
          >
          ...
          <button
            ...
            className="px-4 py-2 rounded-md bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-xs font-bold transition flex items-center space-x-1.5 shadow-sm"
          >
